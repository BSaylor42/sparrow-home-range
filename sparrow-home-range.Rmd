...
```{r kernel density, echo=TRUE, fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
...
```{r compare mcp to kde, echo=TRUE, fig.height=6, fig.width=8, message=FALSE, warning=FALSE}
